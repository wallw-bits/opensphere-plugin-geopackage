...
describe('plugin.geopackage.GeoPackageParser', function() {
  // TODO: replace
  ...
  it('should not parse nonsense', function() {
    ...
    geom = plugin.geopackage.GeoPackageParser.parseGeometry(el);
    expect(geom).toBe(undefined);
  });
  ...
  it('should return undefined for incorrect tag names', function() {
    ...
    expect(plugin.geopackage.GeoPackageParser.parseGeometry(el)).toBe(undefined);
  });

  // TODO: replace
  it('should parse GeoPackage feeds', function() {
    var p = new plugin.geopackage.GeoPackageParser();
